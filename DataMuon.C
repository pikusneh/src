...
void DataMuon()
{
  ...
  //   h9->SetLineColor(kTeal);
  //   h10->SetLineColor(kBlack);

  TFile *fl3 = new TFile("Mu.root", "RECREATE");
  ...
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_b_2016_AnalysisNtuple_1of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_b_2016_AnalysisNtuple_2of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_b_2016_AnalysisNtuple_3of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_b_2016_AnalysisNtuple_4of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_b_2016_AnalysisNtuple_5of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_c_2016_AnalysisNtuple_1of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_c_2016_AnalysisNtuple_2of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_c_2016_AnalysisNtuple_3of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_c_2016_AnalysisNtuple_4of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_c_2016_AnalysisNtuple_5of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_d_2016_AnalysisNtuple_1of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_d_2016_AnalysisNtuple_2of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_d_2016_AnalysisNtuple_3of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_d_2016_AnalysisNtuple_4of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_d_2016_AnalysisNtuple_5of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_e_2016_AnalysisNtuple_1of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_e_2016_AnalysisNtuple_2of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_e_2016_AnalysisNtuple_3of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_e_2016_AnalysisNtuple_4of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_e_2016_AnalysisNtuple_5of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_f_2016_AnalysisNtuple_1of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_f_2016_AnalysisNtuple_2of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_f_2016_AnalysisNtuple_3of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_f_2016_AnalysisNtuple_4of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_f_2016_AnalysisNtuple_5of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_g_2016_AnalysisNtuple_1of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_g_2016_AnalysisNtuple_2of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_g_2016_AnalysisNtuple_3of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_g_2016_AnalysisNtuple_4of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_g_2016_AnalysisNtuple_5of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_h_2016_AnalysisNtuple_1of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_h_2016_AnalysisNtuple_2of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_h_2016_AnalysisNtuple_3of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_h_2016_AnalysisNtuple_4of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/Data_SingleMu_h_2016_AnalysisNtuple_5of5.root");
  ...
  ////////////////////////////////////////Muon Channel////////////////////////
  std::cout << "N+ = " << N_plus_mu << std::endl;
  std::cout << "N- = " << N_minus_mu << std::endl;

  Float_t sum_mu = N_plus_mu + N_minus_mu;
  Float_t diff_mu = N_plus_mu - N_minus_mu;
  std::cout << "sum = " << sum_mu << std::endl;
  ...
  h1->Draw();
  c1->Update();
  c1->SaveAs("/eos/user/s/ssnehshu/plots/DataMu/h1mu.png");
  TCanvas *c2 = new TCanvas();
  c2->cd();
  h2->Draw();
  c2->Update();
  c2->SaveAs("/eos/user/s/ssnehshu/plots/DataMu/h2mu.png");
  TCanvas *c3 = new TCanvas();
  c3->cd();
  h3->Draw();
  c3->Update();
  c3->SaveAs("/eos/user/s/ssnehshu/plots/DataMu/h3mu.png");
  ...
  h6->Draw();
  c6->Update();
  c6->SaveAs("/eos/user/s/ssnehshu/plots/DataMu/h6mu.png");
  TCanvas *c7 = new TCanvas();
  c7->cd();
  h7->Draw();
  c7->Update();
  c7->SaveAs("/eos/user/s/ssnehshu/plots/DataMu/h7mu.png");
  TCanvas *c8 = new TCanvas();
  c8->cd();
  h8->Draw();
  c8->Update();
  c8->SaveAs("/eos/user/s/ssnehshu/plots/DataMu/h8mu.png");
  TCanvas *c9 = new TCanvas();
  c9->cd();
  h9->Draw();
  c9->Update();
  c9->SaveAs("/eos/user/s/ssnehshu/plots/DataMu/h9mu.png");
  TCanvas *c10 = new TCanvas();
  c10->cd();
  h10->Draw();
  c10->Update();
  c10->SaveAs("/eos/user/s/ssnehshu/plots/DataMu/h10mu.png");
  TCanvas *c11 = new TCanvas();
  c11->cd();
  h9ele->Draw("P");
  c11->Update();
  c11->SaveAs("/eos/user/s/ssnehshu/plots/DataMu/h9electrontop.png");

  TCanvas *c12 = new TCanvas();
  c12->cd();
  h10ele->Draw("P");
  c12->Update();
  c12->SaveAs("/eos/user/s/ssnehshu/plots/DataMu/h10electronantitop.png");

  TCanvas *c13 = new TCanvas();
  c13->cd();
  h9mu->Draw("P");
  c13->Update();
  c13->SaveAs("/eos/user/s/ssnehshu/plots/DataMu/h9mutop.png");

  TCanvas *c14 = new TCanvas();
  c14->cd();
  h10mu->Draw("P");
  c14->Update();
  c14->SaveAs("/eos/user/s/ssnehshu/plots/DataMu/h10muantitop.png");
