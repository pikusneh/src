...
void TTbar()
{
  ...
  TH1F *h14 = new TH1F("h14", "Charge Asymmetry vs TTbarmass Electronchannel-TTbar Sample", 7, 300, 1000);
  TH1F *h17 = new TH1F("h17", "Charge Asymmetry vs TTbarmass Muonchannel-TTbar Sample", 7, 300, 1000);
  TH1F *h18 = new TH1F("h18", "Charge Asymmetry vs TTbar Transverse Momentum Electronchannel-TTbar Sample", 4, -200, 1000);
  TH1F *h19 = new TH1F("h19", "Charge Asymmetry vs TTbar Transverse Momentum Muonchannel-TTbar Sample", 4, -200, 1000);
  TH1F *h21 = new TH1F("h21", "Charge Asymmetry vs Photon Transverse Momentum Electronchannel-TTbar Sample", 5, -150, 800);
  TH1F *h22 = new TH1F("h22", "Charge Asymmetry vs Photon Transverse Momentum Muonchannel-TTbar Sample", 5, -150, 800);
  TH1F *h25 = new TH1F("h25","Rapidity",4,-3,3);
  TH1F *h26 = new TH1F("h26","mu_Rapidity",4,-3,3);
  ...
  h14->SetMarkerColor(kBlue);
  h17->SetMarkerColor(kBlue);
  ...
  TFile *fl1 = new TFile("TTbar.root", "RECREATE");
  TChain *tr = new TChain("AnalysisTree");
  // saving N+ and N- value in root
  TFile *file2 = new TFile("output_TTbar.root", "RECREATE");
  TTree *tree2 = new TTree("tree2", "tree2");

  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/TTbarPowheg_Dilepton_2016_AnalysisNtuple_1of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/TTbarPowheg_Dilepton_2016_AnalysisNtuple_2of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/TTbarPowheg_Dilepton_2016_AnalysisNtuple_3of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/TTbarPowheg_Dilepton_2016_AnalysisNtuple_4of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/TTbarPowheg_Dilepton_2016_AnalysisNtuple_5of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/TTbarPowheg_Hadronic_2016_AnalysisNtuple.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/TTbarPowheg_Semilept_2016_AnalysisNtuple_1of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/TTbarPowheg_Semilept_2016_AnalysisNtuple_2of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/TTbarPowheg_Semilept_2016_AnalysisNtuple_3of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/TTbarPowheg_Semilept_2016_AnalysisNtuple_4of5.root");
  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/TTbarPowheg_Semilept_2016_AnalysisNtuple_5of5.root");
  ...
  tree2->Branch("N_plus3", &N_plus3, "N_plus3/F");
  tree2->Branch("N_minus3", &N_minus3, "N_minus3/F");
  tree2->Branch("N_plus4", &N_plus4, "N_plus4/F");
  tree2->Branch("N_minus4", &N_minus4, "N_minus4/F");
  ...
  for (Int_t i = 0; i < numevents; i++)
  {
...

    {
      ...
      if (YPho >= 1)
      {
        ...
        /////////////////////////////////////////////////////fill N+ and N- value in difeerent range of Pt for electron channel///////////////////////////////////
...

    {
      ...
      if (YPho >= 1)
      {
        ...
        if (sub2 > 0)
        {
          N_plus4 = N_plus4 + weight; // single one value of N+ including both channel
        }
        if (sub2 < 0)
        {
          N_minus4 = N_minus4 + weight; // single one value of N- including both channel
        }
        //  cout<<"testing 3"<<endl;
        // h23->Fill(YPho);
        tree2->Fill();
  ...
  ////////////////////////////////////////////
  Float_t sum = N_plus4 + N_minus4;
  Float_t diff = N_plus4 - N_minus4;
  ...
  if (sum != 0)
  {
    ...
    Float_t Delta_N_plus = sqrt(N_plus4);
    Float_t Delta_N_minus = sqrt(N_minus4);
    Float_t Delta_Ac = Ac * sqrt((Delta_diff / diff) * (Delta_diff / diff) + (Delta_sum / sum) * (Delta_sum / sum));
    std::cout << "Asymmetry for TTbar = " << Ac << " ± " << Delta_Ac << std::endl;
  }
  else
  {
  ...
  h1->Draw();
  c1->Update();
  c1->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/h1ttbar.png");
  TCanvas *c2 = new TCanvas();
  c2->cd();
  h2->Draw();
  c2->Update();
  c2->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/h2ttbar.png");
  TCanvas *c3 = new TCanvas();
  c3->cd();
  h3->Draw();
  c3->Update();
  c3->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/h3ttbar.png");
  ...
  h6->Draw();
  c6->Update();
  c6->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/h6ttbar.png");
  TCanvas *c7 = new TCanvas();
  c7->cd();
  h7->Draw();
  c7->Update();
  c7->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/h7ttbar.png");
  TCanvas *c8 = new TCanvas();
  c8->cd();
  h8->Draw();
  c8->Update();
  c8->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/h8ttbar.png");
  TCanvas *c9 = new TCanvas();
  c9->cd();
  h9->Draw();
  c9->Update();
  c9->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/h9ttbar.png");
  TCanvas *c10 = new TCanvas();
  c10->cd();
  h10->Draw();
  c10->Update();
  c10->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/h10ttbar.png");

  TCanvas *c11 = new TCanvas();
  c11->cd();
  h9ele->Draw();
  c11->Update();
  c11->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/h9electrontop.png");

  TCanvas *c12 = new TCanvas();
  c12->cd();
  h10ele->Draw();
  c12->Update();
  c12->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/h10electronantitop.png");

  TCanvas *c13 = new TCanvas();
  c13->cd();
  h9mu->Draw();
  c13->Update();
  c13->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/h9mutop.png");

  TCanvas *c14 = new TCanvas();
  c14->cd();
  h10mu->Draw();
  c14->Update();
  c14->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/h10muantitop.png");

  TCanvas *c15 = new TCanvas();
  c15->cd();
  h11phi->Draw();
  c15->Update();
  c15->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/h11phi.png");

  TCanvas *c16 = new TCanvas();
  c16->cd();
  h12phi->Draw();
  c16->Update();
  c16->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/h12phi.png");
  ...
  leg1->Draw();
  c17->Update();
  c17->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/Ac_ele vs ttbarmass.png");

  TCanvas *c18 = new TCanvas();
  c18->cd();
  h15->Draw();
  c18->Update();
  c18->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/masstop.png");

  TCanvas *c19 = new TCanvas();
  c19->cd();
  h16->Draw();
  c19->Update();
  c19->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/Acele.png");
  ...
  leg2->Draw();
  c20->Update();
  c20->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/Ac_mu vs ttbarmass.png");
  ...
  h18->SetOption("E");
  c21->Update();
  c21->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/Ac_ele vs Pt_ele.png");
  ...
  h19->SetOption("E1");
  c22->Update();
  c22->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/Ac_mu vs Pt_mu.png");
  ...
  h21->SetOption("E1");
  c23->Update();
  c23->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/Ac_ele vs Pho_pt_ele.png");
  ...
  h22->SetOption("E1");
  c24->Update();
  c24->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/Ac_mu vs Pho_pt_mu.png");

  TCanvas *c25 = new TCanvas();
  c25->cd();
  h25->Draw();
  c25->Update();
  c25->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/Rapidity_ele.png");

  TCanvas *c26 = new TCanvas();
  c26->cd();
  h26->Draw();
  c26->Update();
  c26->SaveAs("/eos/user/s/ssnehshu/plots/TTbar/Rapidity_mu.png");
