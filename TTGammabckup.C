...
void TTGammabckup()
{
  ...
  TFile *fl = new TFile("zgamma.root", "RECREATE");
  TChain *tr = new TChain("AnalysisTree");
  // saving N+ and N- value in root
  TFile *file1 = new TFile("output_zgamma.root", "RECREATE");

  TTree *tree1 = new TTree("tree1", "tree1");

  tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/ZGamma_01J_5f_lowMass_2016_AnalysisNtuple.root");
  ...
  for (Int_t i = 0; i < numevents; i++)
  {
...

    {
      ...
      if (YPho >= 1)
      {
        ...
        sub_ele = YT_ele - Yt_ele;           // difference of rapidity; delta y
        // std::cout << "Rapidity = " << sub_ele << std::endl;
