...
void TTGamma()
{
  ...
  leg1->Draw();
  c17->Update();
  c17->SaveAs("/eos/user/s/ssnehshu/plots/TTGamma/Ac_ele vs ttbarmass.png");
  ...
  leg2->Draw();
  c20->Update();
  c20->SaveAs("/eos/user/s/ssnehshu/plots/TTGamma/Ac_mu vs ttbarmass.png");
  ...
  h18->SetOption("E");
  c21->Update();
  c21->SaveAs("/eos/user/s/ssnehshu/plots/TTGamma/Ac_ele vs Pt_ele.png");
  ...
  h19->SetOption("E1");
  c22->Update();
  c22->SaveAs("/eos/user/s/ssnehshu/plots/TTGamma/Ac_mu vs Pt_mu.png");

  TCanvas *c23 = new TCanvas();
  c23->cd();
  h20->Draw();
  c23->Update();
  c23->SaveAs("/eos/user/s/ssnehshu/plots/TTGamma/Pho_pt_ele.png");
  ...
  h21->SetOption("E1");
  c24->Update();
  c24->SaveAs("/eos/user/s/ssnehshu/plots/TTGamma/Ac_ele vs Pho_pt_ele.png");
  ...
  h22->SetOption("E1");
  c25->Update();
  c25->SaveAs("/eos/user/s/ssnehshu/plots/TTGamma/Ac_mu vs Pho_pt_mu.png");
