...
void GenLevel_Preselcuts()
{
    ...
    TFile *fl = new TFile("GenLevel_pre.root", "RECREATE");
    TChain *tr = new TChain("AnalysisTree");

    TFile *file1 = new TFile("output_GenLevel_pre.root", "RECREATE");
    ...
    h1->Draw();
    c1->Update();
    c1->SaveAs("/eos/user/s/ssnehshu/GenLevel_Pre/Top_Pt.png");

    TCanvas *c2 = new TCanvas();
    c2->cd();
    h2->Draw();
    c2->Update();
    c2->SaveAs("/eos/user/s/ssnehshu/GenLevel_Pre/TopAntitop_Pt.png");

    TCanvas *c3 = new TCanvas();
    c3->cd();
    h3->Draw();
    c3->Update();
    c3->SaveAs("/eos/user/s/ssnehshu/GenLevel_Pre/TopAntitop_mass.png");
    ...
    h4->Draw("E1");
    c4->Update();
    c4->SaveAs("/eos/user/s/ssnehshu/GenLevel_Pre/Ac_ele vs ttbarmass.png");

    TCanvas *c5 = new TCanvas();
    c5->cd();
    h5->Draw();
    c5->Update();
    c5->SaveAs("/eos/user/s/ssnehshu/GenLevel_Pre/Top_Rapidity.png");

    TCanvas *c6 = new TCanvas();
    c6->cd();
    h6->Draw();
    c6->Update();
    c6->SaveAs("/eos/user/s/ssnehshu/GenLevel_Pre/Antitop_Rapidity.png");

    TCanvas *c7 = new TCanvas();
    c7->cd();
    h7->Draw();
    c7->Update();
    c7->SaveAs("/eos/user/s/ssnehshu/GenLevel_Pre/Rapidity_Gen.png");
