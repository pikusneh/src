...
void wjets()
{
    ...
    TFile *fl = new TFile("wjets.root", "RECREATE");
    TChain *tr = new TChain("AnalysisTree");
    // saving N+ and N- value in root
    TFile *file1 = new TFile("output_wjets.root", "RECREATE");

    TTree *tree1 = new TTree("tree1", "tree1");

    tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/W1jets_2016_AnalysisNtuple.root");
    tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/W2jets_2016_AnalysisNtuple.root");
    tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/W3jets_2016_AnalysisNtuple.root");
    tr->Add("/eos/user/s/ssnehshu/topquarksample/2016/W4jets_2016_AnalysisNtuple.root");
    ...
    h1->Draw();
    c1->Update();
    c1->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/h1.png");
    TCanvas *c2 = new TCanvas();
    c2->cd();
    h2->Draw();
    c2->Update();
    c2->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/h2.png");
    TCanvas *c3 = new TCanvas();
    c3->cd();
    h3->Draw();
    c3->Update();
    c3->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/h3.png");
   ...
   h6->Draw();
   c6->Update();
   c6->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/h6.png");
   TCanvas *c7 = new TCanvas();
   c7->cd();
   h7->Draw();
   c7->Update();
   c7->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/h7.png");*/
    TCanvas *c8 = new TCanvas();
    c8->cd();
    h8->Draw();
    c8->Update();
    c8->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/h8.png");
    TCanvas *c9 = new TCanvas();
    c9->cd();
    h9->Draw();
    c9->Update();
    c9->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/h9.png");
    TCanvas *c10 = new TCanvas();
    c10->cd();
    h10->Draw();
    c10->Update();
    c10->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/h10.png");

    TCanvas *c11 = new TCanvas();
    c11->cd();
    h9ele->Draw();
    c11->Update();
    c11->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/h9electrontop.png");

    TCanvas *c12 = new TCanvas();
    c12->cd();
    h10ele->Draw();
    c12->Update();
    c12->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/h10electronantitop.png");

    TCanvas *c13 = new TCanvas();
    c13->cd();
    h9mu->Draw();
    c13->Update();
    c13->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/h9mutop.png");

    TCanvas *c14 = new TCanvas();
    c14->cd();
    h10mu->Draw();
    c14->Update();
    c14->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/h10muantitop.png");

    TCanvas *c15 = new TCanvas();
    c15->cd();
    h11phi->Draw();
    c15->Update();
    c15->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/h11phi.png");

    TCanvas *c16 = new TCanvas();
    c16->cd();
    h12phi->Draw();
    c16->Update();
    c16->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/h12phi.png");
    ...
    leg1->Draw();
    c17->Update();
    c17->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/Ac_ele vs ttbarmass.png");

    TCanvas *c18 = new TCanvas();
    c18->cd();
    h15->Draw();
    c18->Update();
    c18->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/masstop.png");

    TCanvas *c19 = new TCanvas();
    c19->cd();
    h16->Draw();
    c19->Update();
    c19->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/Acele.png");
    ...
    leg2->Draw();
    c20->Update();
    c20->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/Ac_mu vs ttbarmass.png");
    ...
    h18->SetOption("E");
    c21->Update();
    c21->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/Ac_ele vs Pt_ele.png");
    ...
    h19->SetOption("E1");
    c22->Update();
    c22->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/Ac_mu vs Pt_mu.png");

    TCanvas *c23 = new TCanvas();
    c23->cd();
    h20->Draw();
    c23->Update();
    c23->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/Pho_pt_ele.png");
    ...
    h21->SetOption("E1");
    c24->Update();
    c24->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/Ac_ele vs Pho_pt_ele.png");
    ...
    h22->SetOption("E1");
    c25->Update();
    c25->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/Ac_mu vs Pho_pt_mu.png");

    TCanvas *c26 = new TCanvas();
    c26->cd();
    h23->Draw();
    c26->Update();
    c26->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/YPho.png");

    TCanvas *c27 = new TCanvas();
    c27->cd();
    h25->Draw();
    c27->Update();
    c27->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/Rapidity_ele.png");

    TCanvas *c28 = new TCanvas();
    c28->cd();
    h26->Draw();
    c28->Update();
    c28->SaveAs("/eos/user/s/ssnehshu/plots/Wjets/Rapidity_mu.png");
